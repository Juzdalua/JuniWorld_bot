...
function CommandBot() {
    return __awaiter(this, void 0, void 0, function () {
        var commandsInit, commands, rest, guildId;
        return __generator(this, function (_a) {
            ...
            commands = commandsInit.map(function (command) { return command.toJSON(); });
            rest = new rest_1.REST({ version: '9' }).setToken(process.env.DISCORD_BOT_TOKEN);
            guildId = "960486734154575892";
            rest.put(v9_1.Routes.applicationCommands(process.env.DISCORD_ID), { body: commands })
